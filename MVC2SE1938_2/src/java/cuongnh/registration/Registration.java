 ...
 */
@Entity
@Table(name = "Registration", catalog = "PRJSE1938", schema = "dbo")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Registration.findByLikeLastname", query = "SELECT r FROM Registration r WHERE r.lastname LIKE :lastname")})
